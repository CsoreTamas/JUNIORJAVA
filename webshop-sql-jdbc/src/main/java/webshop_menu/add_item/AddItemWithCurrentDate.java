...
public class AddItemWithCurrentDate {
    public static void addItemCurrentDate(LineReader lineReader, Connection connection) {
        try {
            ...
            String query = "INSERT INTO shop_item (item_name, item_price, quantity) VALUES(?, ?, ?)";
